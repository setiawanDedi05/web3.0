...
const Welcome = () => {
    const { connectWallet, loading, currentAccount, formData, handleChange, sendTransaction }: any = useContext<TransactionContextType>(TransactionContext);
        ...
        <div className='flex w-full justify-center items-center'>
            <div className='flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    {!currentAccount && <button type='button' onClick={connectWallet} className="flex flex-row justify-center items-center my-5 bg-[#2952a3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]">
                        ...
                        <div className='flex justify-between flex-col w-full h-full'>
                            ...
                            <div>
                                <p className='text-white font-light text-sm'>
                                    {currentAccount ? sortAddress(currentAccount) : 'Address    '}
                                </p>
